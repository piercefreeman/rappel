...
class ActionDispatch(_message.Message):
    ...
    def __init__(
        ...
        dispatch: _Optional[_Union[WorkflowNodeDispatch, _Mapping]] = ...,
        timeout_seconds: _Optional[int] = ...,
        max_retries: _Optional[int] = ...,
        attempt_number: _Optional[int] = ...,
        dispatch_token: _Optional[str] = ...,
    ) -> None: ...
...
class ActionResult(_message.Message):
    ...
    def __init__(
        ...
        action_id: _Optional[str] = ...,
        success: bool = ...,
        payload: _Optional[_Union[WorkflowArguments, _Mapping]] = ...,
        worker_start_ns: _Optional[int] = ...,
        worker_end_ns: _Optional[int] = ...,
        dispatch_token: _Optional[str] = ...,
        control: _Optional[_Union[WorkflowNodeControl, _Mapping]] = ...,
    ) -> None: ...
...
class BackoffPolicy(_message.Message):
    ...
    def __init__(
        self,
        linear: _Optional[_Union[LinearBackoff, _Mapping]] = ...,
        exponential: _Optional[_Union[ExponentialBackoff, _Mapping]] = ...,
    ) -> None: ...
...
class ExponentialBackoff(_message.Message):
    ...
    multiplier: float
    def __init__(
        self, base_delay_ms: _Optional[int] = ..., multiplier: _Optional[float] = ...
    ) -> None: ...
...
class WorkflowDagNode(_message.Message):
    ...
    def __init__(
        ...
        wait_for_sync: _Optional[_Iterable[str]] = ...,
        produces: _Optional[_Iterable[str]] = ...,
        module: _Optional[str] = ...,
        guard: _Optional[str] = ...,
        exception_edges: _Optional[_Iterable[_Union[WorkflowExceptionEdge, _Mapping]]] = ...,
        timeout_seconds: _Optional[int] = ...,
        max_retries: _Optional[int] = ...,
        timeout_retry_limit: _Optional[int] = ...,
        loop: _Optional[_Union[WorkflowLoopSpec, _Mapping]] = ...,
        ast: _Optional[_Union[WorkflowNodeAst, _Mapping]] = ...,
        backoff: _Optional[_Union[BackoffPolicy, _Mapping]] = ...,
    ) -> None: ...
...
class WorkflowDagDefinition(_message.Message):
    ...
    def __init__(
        self,
        concurrent: bool = ...,
        nodes: _Optional[_Iterable[_Union[WorkflowDagNode, _Mapping]]] = ...,
        return_variable: _Optional[str] = ...,
    ) -> None: ...
...
class WorkflowExceptionEdge(_message.Message):
    ...
    def __init__(
        ...
        exception_module: _Optional[str] = ...,
    ) -> None: ...
...
class WorkflowLoopSpec(_message.Message):
    ...
    def __init__(
        self,
        iterable_expr: _Optional[str] = ...,
        loop_var: _Optional[str] = ...,
        accumulator: _Optional[str] = ...,
        preamble: _Optional[str] = ...,
        body_action: _Optional[str] = ...,
        body_module: _Optional[str] = ...,
        body_kwargs: _Optional[_Mapping[str, str]] = ...,
    ) -> None: ...
...
class WorkflowLoopControl(_message.Message):
    ...
    class PhaseResultsEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[WorkflowArgumentValue, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        ...
        next_index: _Optional[int] = ...,
        has_next: bool = ...,
        accumulator: _Optional[str] = ...,
        accumulator_value: _Optional[_Union[WorkflowArgumentValue, _Mapping]] = ...,
        completed_phases: _Optional[_Iterable[str]] = ...,
        phase_results: _Optional[_Mapping[str, WorkflowArgumentValue]] = ...,
...
class WorkflowNodeAst(_message.Message):
    ...
    class KwargsEntry(_message.Message):
        ...
        value: Expr
        def __init__(
            self, key: _Optional[str] = ..., value: _Optional[_Union[Expr, _Mapping]] = ...
        ) -> None: ...
    ...
    def __init__(
        self,
        kwargs: _Optional[_Mapping[str, Expr]] = ...,
        guard: _Optional[_Union[Expr, _Mapping]] = ...,
        loop: _Optional[_Union[LoopAst, _Mapping]] = ...,
        sleep_duration: _Optional[_Union[Expr, _Mapping]] = ...,
    ) -> None: ...
...
class LoopAst(_message.Message):
    ...
    def __init__(
        self,
        iterable: _Optional[_Union[Expr, _Mapping]] = ...,
        loop_var: _Optional[str] = ...,
        accumulator: _Optional[str] = ...,
        preamble: _Optional[_Iterable[_Union[Stmt, _Mapping]]] = ...,
        body_action: _Optional[_Union[ActionAst, _Mapping]] = ...,
        body_graph: _Optional[_Union[LoopBodyGraph, _Mapping]] = ...,
    ) -> None: ...
...
class LoopBodyGraph(_message.Message):
    ...
    def __init__(
        self,
        nodes: _Optional[_Iterable[_Union[LoopBodyNode, _Mapping]]] = ...,
        result_variable: _Optional[str] = ...,
    ) -> None: ...
...
class LoopBodyNode(_message.Message):
    ...
    def __init__(
        ...
        action: _Optional[str] = ...,
        module: _Optional[str] = ...,
        kwargs: _Optional[_Iterable[_Union[Keyword, _Mapping]]] = ...,
        depends_on: _Optional[_Iterable[str]] = ...,
        output_var: _Optional[str] = ...,
        timeout_seconds: _Optional[int] = ...,
        max_retries: _Optional[int] = ...,
    ) -> None: ...
...
class ActionAst(_message.Message):
    ...
    def __init__(
        ...
        keywords: _Optional[_Iterable[_Union[Keyword, _Mapping]]] = ...,
    ) -> None: ...
...
class Keyword(_message.Message):
    ...
    value: Expr
    def __init__(
        self, arg: _Optional[str] = ..., value: _Optional[_Union[Expr, _Mapping]] = ...
    ) -> None: ...
...
class Assign(_message.Message):
    ...
    def __init__(
        self,
        targets: _Optional[_Iterable[_Union[Expr, _Mapping]]] = ...,
...
class Expr(_message.Message):
    ...
    def __init__(
        self,
        name: _Optional[_Union[Name, _Mapping]] = ...,
        constant: _Optional[_Union[Constant, _Mapping]] = ...,
        attribute: _Optional[_Union[Attribute, _Mapping]] = ...,
        subscript: _Optional[_Union[Subscript, _Mapping]] = ...,
        bin_op: _Optional[_Union[BinOp, _Mapping]] = ...,
        bool_op: _Optional[_Union[BoolOp, _Mapping]] = ...,
        compare: _Optional[_Union[Compare, _Mapping]] = ...,
        call: _Optional[_Union[Call, _Mapping]] = ...,
        list: _Optional[_Union[List, _Mapping]] = ...,
        tuple: _Optional[_Union[Tuple, _Mapping]] = ...,
        dict: _Optional[_Union[Dict, _Mapping]] = ...,
...
class Attribute(_message.Message):
    ...
    attr: str
    def __init__(
        self, value: _Optional[_Union[Expr, _Mapping]] = ..., attr: _Optional[str] = ...
    ) -> None: ...
...
class Subscript(_message.Message):
    ...
    def __init__(
        self,
        value: _Optional[_Union[Expr, _Mapping]] = ...,
        slice: _Optional[_Union[Expr, _Mapping]] = ...,
    ) -> None: ...
...
class BinOp(_message.Message):
    ...
    def __init__(
        self,
        left: _Optional[_Union[Expr, _Mapping]] = ...,
        op: _Optional[_Union[BinOpKind, str]] = ...,
        right: _Optional[_Union[Expr, _Mapping]] = ...,
    ) -> None: ...
...
class BoolOp(_message.Message):
    ...
    def __init__(
        self,
        op: _Optional[_Union[BoolOpKind, str]] = ...,
...
class Compare(_message.Message):
    ...
    def __init__(
        self,
        left: _Optional[_Union[Expr, _Mapping]] = ...,
        ops: _Optional[_Iterable[_Union[CmpOpKind, str]]] = ...,
        comparators: _Optional[_Iterable[_Union[Expr, _Mapping]]] = ...,
    ) -> None: ...
...
class Call(_message.Message):
    ...
    def __init__(
        self,
        func: _Optional[_Union[Expr, _Mapping]] = ...,
...
class UnaryOp(_message.Message):
    ...
    def __init__(
        self,
        op: _Optional[_Union[UnaryOpKind, str]] = ...,
...
class Dict(_message.Message):
    ...
    def __init__(
        self,
        keys: _Optional[_Iterable[_Union[Expr, _Mapping]]] = ...,
        values: _Optional[_Iterable[_Union[Expr, _Mapping]]] = ...,
    ) -> None: ...
...
class WorkflowRegistration(_message.Message):
    ...
    def __init__(
        ...
        dag: _Optional[_Union[WorkflowDagDefinition, _Mapping]] = ...,
        dag_hash: _Optional[str] = ...,
        initial_context: _Optional[_Union[WorkflowArguments, _Mapping]] = ...,
    ) -> None: ...
...
class WorkflowNodeContext(_message.Message):
    ...
    def __init__(
        ...
        payload: _Optional[_Union[WorkflowArguments, _Mapping]] = ...,
        workflow_node_id: _Optional[str] = ...,
    ) -> None: ...
...
class WorkflowArgumentValue(_message.Message):
    ...
    def __init__(
        self,
        primitive: _Optional[_Union[PrimitiveWorkflowArgument, _Mapping]] = ...,
        basemodel: _Optional[_Union[BaseModelWorkflowArgument, _Mapping]] = ...,
        exception: _Optional[_Union[WorkflowErrorValue, _Mapping]] = ...,
        list_value: _Optional[_Union[WorkflowListArgument, _Mapping]] = ...,
        tuple_value: _Optional[_Union[WorkflowTupleArgument, _Mapping]] = ...,
        dict_value: _Optional[_Union[WorkflowDictArgument, _Mapping]] = ...,
    ) -> None: ...
...
class WorkflowArguments(_message.Message):
    ...
    def __init__(
        self, arguments: _Optional[_Iterable[_Union[WorkflowArgument, _Mapping]]] = ...
    ) -> None: ...
...
class BaseModelWorkflowArgument(_message.Message):
    ...
    def __init__(
        ...
        module: _Optional[str] = ...,
        name: _Optional[str] = ...,
        data: _Optional[_Union[WorkflowDictArgument, _Mapping]] = ...,
    ) -> None: ...
...
class WorkflowListArgument(_message.Message):
    ...
    def __init__(
        self, items: _Optional[_Iterable[_Union[WorkflowArgumentValue, _Mapping]]] = ...
    ) -> None: ...
...
class WorkflowDictArgument(_message.Message):
    ...
    def __init__(
        self, entries: _Optional[_Iterable[_Union[WorkflowArgument, _Mapping]]] = ...
    ) -> None: ...
...
class WorkflowNodeDispatch(_message.Message):
    ...
    def __init__(
        self,
        node: _Optional[_Union[WorkflowDagNode, _Mapping]] = ...,
        workflow_input: _Optional[_Union[WorkflowArguments, _Mapping]] = ...,
        context: _Optional[_Iterable[_Union[WorkflowNodeContext, _Mapping]]] = ...,
        resolved_kwargs: _Optional[_Union[WorkflowArguments, _Mapping]] = ...,
    ) -> None: ...
...
class RegisterWorkflowRequest(_message.Message):
    ...
    def __init__(
        self, registration: _Optional[_Union[WorkflowRegistration, _Mapping]] = ...
    ) -> None: ...
...
class RegisterWorkflowResponse(_message.Message):
    ...
    def __init__(
        self, workflow_version_id: _Optional[str] = ..., workflow_instance_id: _Optional[str] = ...
    ) -> None: ...
...
class WaitForInstanceRequest(_message.Message):
    ...
    def __init__(
        self, instance_id: _Optional[str] = ..., poll_interval_secs: _Optional[float] = ...
    ) -> None: ...
