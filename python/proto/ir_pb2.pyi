...
class Literal(_message.Message):
    ...
    float_value: float
    string_value: str
    def __init__(self, null_value: bool = ..., bool_value: bool = ..., int_value: _Optional[int] = ..., float_value: _Optional[float] = ..., string_value: _Optional[str] = ...) -> None: ...

class Expression(_message.Message):
    __slots__ = ("literal", "variable", "subscript", "array", "dict", "binary_op", "unary_op", "call", "attribute")
    ...
    def __init__(self, literal: _Optional[_Union[Literal, _Mapping]] = ..., variable: _Optional[str] = ..., subscript: _Optional[_Union[Subscript, _Mapping]] = ..., array: _Optional[_Union[ArrayExpr, _Mapping]] = ..., dict: _Optional[_Union[DictExpr, _Mapping]] = ..., binary_op: _Optional[_Union[BinaryOp, _Mapping]] = ..., unary_op: _Optional[_Union[UnaryOp, _Mapping]] = ..., call: _Optional[_Union[CallExpr, _Mapping]] = ..., attribute: _Optional[_Union[AttributeAccess, _Mapping]] = ...) -> None: ...
...
class Subscript(_message.Message):
    ...
    base: Expression
    key: Expression
    def __init__(self, base: _Optional[_Union[Expression, _Mapping]] = ..., key: _Optional[_Union[Expression, _Mapping]] = ...) -> None: ...
...
class AttributeAccess(_message.Message):
    ...
    base: Expression
    attribute: str
    def __init__(self, base: _Optional[_Union[Expression, _Mapping]] = ..., attribute: _Optional[str] = ...) -> None: ...
...
class DictExpr(_message.Message):
    ...
    def __init__(self, entries: _Optional[_Iterable[_Union[DictEntry, _Mapping]]] = ...) -> None: ...
...
class DictEntry(_message.Message):
    ...
    key: str
    value: Expression
    def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[Expression, _Mapping]] = ...) -> None: ...
...
class BinaryOp(_message.Message):
    ...
    left: Expression
    right: Expression
    def __init__(self, op: _Optional[_Union[BinaryOp.Op, str]] = ..., left: _Optional[_Union[Expression, _Mapping]] = ..., right: _Optional[_Union[Expression, _Mapping]] = ...) -> None: ...
...
class UnaryOp(_message.Message):
    ...
    op: UnaryOp.Op
    operand: Expression
    def __init__(self, op: _Optional[_Union[UnaryOp.Op, str]] = ..., operand: _Optional[_Union[Expression, _Mapping]] = ...) -> None: ...
...
class CallExpr(_message.Message):
    ...
    def __init__(self, function: _Optional[str] = ..., args: _Optional[_Iterable[_Union[Expression, _Mapping]]] = ...) -> None: ...
...
class KwArg(_message.Message):
    ...
    name: str
    value: Expression
    def __init__(self, name: _Optional[str] = ..., value: _Optional[_Union[Expression, _Mapping]] = ...) -> None: ...
...
class ActionCall(_message.Message):
    ...
    def __init__(self, action: _Optional[str] = ..., module: _Optional[str] = ..., args: _Optional[_Iterable[_Union[KwArg, _Mapping]]] = ..., target: _Optional[str] = ..., config: _Optional[_Union[RunActionConfig, _Mapping]] = ..., location: _Optional[_Union[SourceLocation, _Mapping]] = ...) -> None: ...
...
class SubgraphCall(_message.Message):
    ...
    target: str
    location: SourceLocation
    def __init__(self, method_name: _Optional[str] = ..., args: _Optional[_Iterable[_Union[KwArg, _Mapping]]] = ..., target: _Optional[str] = ..., location: _Optional[_Union[SourceLocation, _Mapping]] = ...) -> None: ...
...
class Loop(_message.Message):
    ...
    location: SourceLocation
    def __init__(self, iterator: _Optional[_Union[Expression, _Mapping]] = ..., loop_var: _Optional[str] = ..., accumulator: _Optional[str] = ..., body: _Optional[_Iterable[_Union[Statement, _Mapping]]] = ..., location: _Optional[_Union[SourceLocation, _Mapping]] = ...) -> None: ...
...
class Branch(_message.Message):
    ...
    location: SourceLocation
    def __init__(self, guard: _Optional[_Union[Expression, _Mapping]] = ..., preamble: _Optional[_Iterable[_Union[PythonBlock, _Mapping]]] = ..., actions: _Optional[_Iterable[_Union[ActionCall, _Mapping]]] = ..., postamble: _Optional[_Iterable[_Union[PythonBlock, _Mapping]]] = ..., location: _Optional[_Union[SourceLocation, _Mapping]] = ...) -> None: ...
...
class Sleep(_message.Message):
    ...
    duration: Expression
    location: SourceLocation
    def __init__(self, duration: _Optional[_Union[Expression, _Mapping]] = ..., location: _Optional[_Union[SourceLocation, _Mapping]] = ...) -> None: ...
...
class Return(_message.Message):
    ...
    gather: Gather
    location: SourceLocation
    def __init__(self, expression: _Optional[_Union[Expression, _Mapping]] = ..., action: _Optional[_Union[ActionCall, _Mapping]] = ..., gather: _Optional[_Union[Gather, _Mapping]] = ..., location: _Optional[_Union[SourceLocation, _Mapping]] = ...) -> None: ...
...
class Spread(_message.Message):
    ...
    target: str
    location: SourceLocation
    def __init__(self, action: _Optional[_Union[ActionCall, _Mapping]] = ..., loop_var: _Optional[str] = ..., iterable: _Optional[_Union[Expression, _Mapping]] = ..., target: _Optional[str] = ..., location: _Optional[_Union[SourceLocation, _Mapping]] = ...) -> None: ...
